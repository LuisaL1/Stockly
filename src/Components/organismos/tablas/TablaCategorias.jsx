...
import { ContentAccionesTabla, Paginacion, useCategoriasStore, v,ColorContent } from "../../../index";
import Swal from "sweetalert2";
import {FaArrowsAltV} from "react-icons/fa"
import { useState } from "react";
import { EliminarCategoria } from "../../../supabase/crudCategorias";
export function TablaCategorias({ data, SetopenRegistro,
  ...
  const columns = [
    {
    ...
    },
     {
      ...
      className="ContentCell">
        <ColorContent $color={info.getValue()} $alto="25px"
        $ancho="25px"/>
        </td>
    },
{
